    ...
    <div class="c-adv-index">
        ...
        <div class="c-main">
            ...
            <div class="c-grid-footer">
                ...
                <div class="c-right">
                    <el-pagination @current-change="changePage" :current-page="currentPage" :page-size="perPage" :total="totalCount" layout="total, prev, pager, next, jumper"></el-pagination>
                </div>
            </div>
        </div>
    </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            create () {
                this.$router.push('/content/adv/create')
            },
            view () {
                console.log("查看广告详情")
            },
            modify (id) {
                this.$router.push({path: '/content/adv/update', query: { id }})
            },
            changePage (page) {
                this.search(page)
            },
