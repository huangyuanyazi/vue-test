        ...
        <div class="c-main">
            <tq-form ref="patentDetail">
                <div>
                    ...
                    <tq-form-item name="name" label="审查状态：">
                        <div style="margin-top: 7px;">{{patent.review_status ? patent.review_status.status : '无'}}</div>
                    </tq-form-item>
                </div>
    ...
    export default {
        ...
        mounted () {
            ...
            this.$http.get('/cs-payment-statuses').then(paymentStatusesRes => {
                ...
                return this.$http.get("/cs-patents/" + this.$route.query.id)
            }).then(patentsRes => {
