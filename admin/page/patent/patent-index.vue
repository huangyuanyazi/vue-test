    ...
    <div class="c-patent-index">
        ...
        <div class="c-main">
            <el-table :data="patents" border class="">
                ...
                <el-table-column label="审查状态" width="140">
                    <template scope="scope">
                        {{scope.row.review_status ? scope.row.review_status.status : '无'}}
                    </template>
                </el-table-column>
...
<script>
    export default {
        ...
        methods: {
            ...
            create () {
                this.$router.push('/patent/patent/create')
            },
            view (id) {
                this.$router.push({ path: '/patent/patent/detail', query: { id }})
            },
            modify (id) {
                this.$router.push({ path: '/patent/patent/update', query: { id }})
            },
            modifyStatuses () {
                this.$router.push('/patent/patent-status/batch-create')
            }
        }
    }
</script>