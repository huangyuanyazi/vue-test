    ...
    <div class="c-item-batch-edit">
        ...
        <div class="c-main">
            ...
            <tq-form v-show="1 === step">
                <tq-form-item label="选择店铺">
                    <el-select v-model="store_id" filterable>
                        <el-option v-for="store in stores" :label="store.name" :value="store.id" :key="store.id"></el-option>
                    </el-select>
                </tq-form-item>
                <tq-form-item>
                    <el-button type="primary" @click="toUpload" :disabled="store_id === null">下一步，导入Excel</el-button>
            ...
            <div class="c-form" v-show="2 === step">
                <div class="c-form-content">
                    <el-form ref="uploadForm" label-width="80px">
                        ...
                        <el-form-item>
                            <div style="width: 360px; text-align: center"><el-button @click="toStore">返回上一步</el-button></div>
                        </el-form-item>
                    </el-form>
                </div>
            </div>
            ...
            <!--3.上传和解析进度-->
            <div class="c-form" v-show="3 === step">
            ...
            <div v-show="4 === step">
                <div style="position: fixed; top: 60px; z-index: 200; left: 50%; background-color: #FFF; padding: 10px; border-radius: 5px;">
                    ...
                    <el-button @click="toUpload">重新上传</el-button>
                </div>
            ...
            <div v-if="5 === step">
                <div v-if="batchInserted.length > 0 || batchUpdated.length > 0">
                    <div style="position: fixed; top: 60px; z-index: 200; left: 50%; background-color: #FFF; padding: 10px; border-radius: 5px;">
                        <el-button @click="toUpload">继续上传</el-button>
                    </div>
