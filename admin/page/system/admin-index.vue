<template>
    <div class="c-user-index">
        <div class="c-header">
            <div class="c-left">
                <el-button type="primary" size="small" class="c-button" @click="create"><i class="fa fa-plus"></i>新增管理员</el-button>
            </div>
        </div>
        <div class="c-main">
    ...
    export default {
        ...
        methods: {
            ...
            userAuthAssignment (id) {
                this.$router.push({ path: '/system/admin/auth-update', query: { user_id: id }})
            },
            changePage (page) {
                this.search(page)
            }
